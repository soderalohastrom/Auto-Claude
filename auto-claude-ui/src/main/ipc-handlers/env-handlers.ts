...
# =============================================================================
# By default, Auto-Claude uses Anthropic's native endpoint.
# If you want to route Claude/SDK traffic through an Anthropic-compatible proxy
# (e.g., Z.ai GLM), set these two variables.
#
# Anthropic native (default) → leave unset:
...
#
# Example: Z.ai Anthropic-compatible endpoint (uncomment and fill token):
# ANTHROPIC_BASE_URL=https://api.z.ai/api/anthropic
# ANTHROPIC_AUTH_TOKEN=your-zai-auth-token
#
# Optional Z.ai model mapping (Claude Code internal defaults → GLM models):
# ANTHROPIC_DEFAULT_OPUS_MODEL=GLM-4.7
# ANTHROPIC_DEFAULT_SONNET_MODEL=GLM-4.7
# ANTHROPIC_DEFAULT_HAIKU_MODEL=GLM-4.5-Air
#
# Note on "thinking":
# Auto-Claude uses Claude SDK "extended thinking" via max_thinking_tokens.
# If your Anthropic-compatible provider expects a thinking object instead,
# you may need provider-specific support in the SDK/proxy. If Z.ai supports it
# behind the Anthropic schema, the above base URL swap is sufficient.
...
`;
  ...
  ipcMain.handle(
    ...
    async (_, projectId: string): Promise<IPCResult<ProjectEnvConfig>> => {
      ...
      // Anthropic custom endpoint overrides (OPTIONAL)
      // Used for Anthropic-compatible proxies like Z.ai:
      //   ANTHROPIC_BASE_URL=https://api.z.ai/api/anthropic
      //   ANTHROPIC_AUTH_TOKEN=your-zai-auth-token
